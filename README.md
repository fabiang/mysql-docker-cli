...
Interactive Bash which allows you to select Docker MySQL/MariaDB instances
...
1) docker-sftpgo-database-1 (/var/lib/docker/volumes/docker-sftpgo_mariadb_run/_data/mysqld.sock)

To which instance you like to connect? (1-1): 1
🔌 Connecting to /var/lib/docker/volumes/docker-sftpgo_mariadb_run/_data/mysqld.sock ...
Enter password: 
